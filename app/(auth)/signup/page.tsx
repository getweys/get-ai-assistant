...
const page = () => {
  ...
  return (
    <div className="bg-slate-100 h-screen flex flex-col gap-8 justify-center items-center dark:bg-black">
      ...
      <form
        className="h-fit max-w-[450px] w-full  bg-white px-8 py-10 rounded-xl shadow-2xl flex flex-col dark:bg-white"
      ...
      >
        <div className="flex justify-center items-center gap-3">
          ...
          <span className="font-semibold text-xl dark:text-black text-sidebar-foreground tracking-[2px]">
            GET AI Assistant
          </span>
        </div>
        <Text
