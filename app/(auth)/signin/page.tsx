...
const page = () => {
  ...
  return (
    <div className="bg-slate-100 h-screen flex flex-col gap-8 justify-center items-center dark:bg-black">
      <form
        className="h-fit max-w-[450px] w-full  bg-white px-8 py-10 rounded-xl shadow-2xl flex flex-col "
      ...
      >
        <div className="flex justify-center items-center gap-3">
          ...
          <span className="font-semibold text-xl text-sidebar-foreground tracking-[2px] dark:text-black">
            GET AI Assistant
          </span>
        </div>
        <Text
          ...
          className={cn(
            "text-xl text-center font-semibold tracking-[0.6px] mb-[2px] mt-6  dark:text-black"
          )}
        >
          Welcome Back
        </Text>
        <Text
          containerTag={Tags.Paragraph}
          className="text-sm text-semigray text-center tracking-[0.7px]"
        >
          Sign in to access your AI assistant
        </Text>
        <div className="flex flex-col gap-6 py-8">
          <div className="flex flex-col gap-1 ">
            <label className="text-xs font-[450] tracking-[0.5px] dark:text-black">
              Email
            </label>
            <ControlInput
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-[450] dark:text-black tracking-[0.5px]">
              Password
            </label>
            <ControlInput
              className="border rounded-sm px-4 py-2 placeholder:text-xs text-sm text-semigray "
